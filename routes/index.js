...
var data ={
  bytecoin: {//赚流量币
    ...
    bigtime: 0.5, //每N分钟计算一次
    digmaxtime:0.01, //最多累计N小时
    digbytecoin: 0.25 //每bigtime分钟收集N个流量币
  },
  bytecoin_spend:{//花流量币
    coinnum: 11111.0,//用户流量币数
    activity_start_time: '20151123122621',
    activity_end_time: '20151123212021',
    activitylist:[
      {
        id: 1,//		商品id
...
function increment(){
  ...
  var addCoin = Math.floor(digseconds / 60 / data.bytecoin.bigtime)  * data.bytecoin.digbytecoin;
